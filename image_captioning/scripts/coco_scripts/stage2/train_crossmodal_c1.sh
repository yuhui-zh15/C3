...
python3 run.py --config configs/finetuning/coco_stage2_image_captioning.yaml --train --test --random_seed 1234 --normalize_prefix --checkpoint $STAGE1_CHECKPOINT --val_eval --cross_modal_val