...
class StyleGAN2Loss(Loss):
    def __init__(self, device, G_mapping, G_synthesis, G_mani, D, augment_pipe=None, style_mixing_prob=0.9, r1_gamma=10, pl_batch_shrink=2, pl_decay=0.01, pl_weight=2, remove_mean=False, add_noise=False, noise_level=0.75, add_lafite_noise=False, norm_after_remove_mean=False):
        super().__init__()
        self.device = device
